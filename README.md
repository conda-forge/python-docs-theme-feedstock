...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-docs-theme-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-docs-theme-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-docs-theme
# for installing globally
pixi global install python-docs-theme
```
...
It is possible to list all of the versions of `python-docs-theme` available on your platform:
...
```
pixi search python-docs-theme --channel conda-forge
```
